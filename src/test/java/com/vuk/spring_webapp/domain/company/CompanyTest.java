...
class CompanyTest {
    ...
    @Test
    @DisplayName("About must not be blank")
    void aboutMustNotBeBlank() {
        Company company = new Company();
        company.setAbout(" ");
    ...
    @Test
    @DisplayName("About must not exceed 200 characters")
    void aboutMustNotExceed50Characters() {
        Company company = new Company();
        company.setAbout("x".repeat(201));
    ...
    @Test
    @DisplayName("About can have 200 characters")
    void aboutCanHave50Characters() {
        Company company = new Company();
        company.setAbout("x".repeat(200));
    ...
    @Test
    @DisplayName("Valid about produces no violations")
    void validAboutProducesNoViolations() {
        Company company = new Company();
    ...
    void addressMustNotExceed50Characters() {
        Company company = new Company();
        company.setAddress("x".repeat(51));
    ...
    void addressCanHave50Characters() {
        Company company = new Company();
        company.setAddress("x".repeat(50));
